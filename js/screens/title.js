game.TitleScreen = me.ScreenObject.extend({
  ...
  onResetEvent: function () {
    ...
    var logoTween = me.pool
      ...
      .to({ y: me.game.viewport.height / 2 - 120 }, 1000)
      ...
      new (me.Renderable.extend({
        ...
        init: function () {
          ...
          this.text = me.device.touch
            ? "Tap for å starte"
            : "Fly med mellomrom eller museklikk.\n\n\t\tHa en Maria christmas! Hilsen, nissen.";
          this.font = new me.Font("Press Start 2P", 20, "#00AAAA");
        },
        draw: function (renderer) {
          var measure = this.font.measureText(renderer, this.text);
          var xpos = me.game.viewport.width / 2 - measure.width / 2;
          var ypos = me.game.viewport.height / 2;
          this.font.draw(renderer, this.text, xpos, ypos, true);
        },
      }))(),
      12
    );
